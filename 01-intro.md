...
- Robotite tarkvara on tänapäeval peamine pudelikael robootikas!
...
- "Hardcore progemisaine"
- Personaalne tagasiside
- Õppimine kaastudengite abiga (tiimitöö)
...
Aine sisu on jagatud skoobi alusel neljaks rajaks.

---
## Rajad (ingl tracks)

- T1: passiivne õpe
  - tausta/teooritiliste aluste omandamine (quiz)
- T2: aktiivne õpe
  - automaattestidega fokuseeritud ülesanded
- T3: aktiivne õpe
  - simulatsioonipõhine robotite programmeerimine (ideaalsed müravabad robotid)
- T4: aktiivne õpe
  - mitteideaalsete robotite programmeerimine (realistlik simulatsioon või päris elu)

---
## Tiimipõhine õpe

- T1 (quiz) on individuaalne.
...
<img src="https://github.com/iti0201/iti0201/blob/lecture-01/assets/image/pibot2_1.jpg?raw=true"  height="500" width="800">

---
## Robot PiBot cont.

<img src="https://github.com/iti0201/iti0201/blob/lecture-01/assets/image/pibot2_2.jpg?raw=true"  height="500" width="800">

---
## Robot PiBot cont.

<img src="https://github.com/iti0201/iti0201/blob/lecture-01/assets/image/pibot2_3.jpg?raw=true"  height="500" width="800">
...
- Pronks
  - Robot peab sõitma ovaalsel rajal.
- Hõbe
  - Robot peab sõitma ristmikega rajal.
  - Igal ristmikul peab valima kordamööda vasaku, otse ning parema haru.
- Kuld
  - Robot peab mööda manööverdama rajal olevatest takistustest (laser).

---
## Objektid

- Pronks
  - Robot peab laseriga leidma objekti ning selle juurde sõitma.
- Hõbe
...
- Pronks
  - Robot peab siksak-labürindist välja sõitma infrapuna kaugusanduritega.
- Hõbe
  - Robot peab siksak-labürindist välja sõitma laser kaugusanduriga.
- Kuld
  - Robot peab labürindi kaardistama ja seejärel labürindist välja sõitma.

---
## Labürint (2/2)
- Eliit
  - Robot peab labürindi kaardistama, misjärel robot tõstetakse teise kohta ning robot peab uuesti ära tundma, kus ta on. Kui robot on oma asukoha uuesti ära tundnud, peab ta liikuma eelnevalt kokku lepitud nurka.
